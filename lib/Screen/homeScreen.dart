          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: Color(0xff217C7E), // Container ka color
              ),
              child: Row(
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              leading: const Icon(Icons.home, color: Color(0xffb80924)),
              title: Text(
                'Home',
            ...
            ListTile(
              leading: const Icon(Icons.person, color: Color(0xffb80924)),
              title: Text(
                'Profile',
                style: Theme.of(context).textTheme.titleMedium,
              ),
            ...
            ListTile(
              leading: const Icon(Icons.settings, color: Color(0xffb80924)),
              title: Text(
                'Settings',
                style: Theme.of(context).textTheme.titleMedium,
              ),
            ...
            ListTile(
              leading: const Icon(Icons.exit_to_app, color: Color(0xffb80924)),
              title: Text(
                'Logout',
                style: Theme.of(context).textTheme.titleMedium,
              ),
